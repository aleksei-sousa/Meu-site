    ...
    return(
        <footer className={sidebar ? `${styles.filter}`:``} onClick={ss}>
            <div className={styles.container_footer}>
                <h1 className={styles.titulo_footer}>Contatos</h1>
                <div className={styles.content_midias_sociais}>
                    ...
                    //   target='blank'
                      ...
                      <MdOutlineMailOutline size={tamanho} color='white' />
                    </a>
                    <a className={styles.link_midias_sociais} href='https://github.com/saiko1243' target='blank'>
                      <FaGithub size={tamanho} color='white' />
                    </a>
                </div>
            </div>
        </footer>
